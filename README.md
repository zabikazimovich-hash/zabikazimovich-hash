...
<picture>
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:6a11cb,50:2575fc,100:00c6ff&height=280&section=header&animation=fadeIn" width="100%"/>
</picture>
...
<a href="https://skillicons.dev">
  <img src="https://skillicons.dev/icons?i=python,django,flask,fastapi,js,ts,react,nextjs,nodejs,nestjs,postgres,redis,docker,git,figma&theme=dark" />
</a>
...
<a href="https://kwork.ru/user/zabi1ev_">
  <img src="https://img.shields.io/badge/Kwork-FF5C00?style=for-the-badge&logo=kwork&logoColor=white" />
</a>
...
Сервис такси нового поколения: приложения для водителей и пассажиров на React Native, бэкенд на NestJS + Prisma + PostgreSQL, real-time трекинг через Socket.io, хранение файлов на AWS.
...
Веб-версия сервиса такси: React-фронтенд и Express-бэкенд с Prisma, отдельный контур для заказа поездок через браузер.
...
Маркетплейс аренды и продажи недвижимости: веб-платформа на Next.js + Telegram-бот на общей базе данных, личный кабинет, каталог, бронирования, CRM.
...
AI-платформа поздравительных открыток: сайт, Telegram Mini App, мобильное приложение, бизнес-панель и бэкенд на общей базе данных.
...
Сервис онлайн-защиты/безопасности: React-фронтенд и Express-бэкенд с Prisma, авторизация и защищённые маршруты.
...
Личный сайт-портфолио на Flask с деплоем на Heroku — визитка со всеми проектами и контактами.
