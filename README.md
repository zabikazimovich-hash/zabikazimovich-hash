...
- 🏗️ **Веду параллельно несколько продакшн-продуктов** — от сервисов такси до маркетплейса аренды недвижимости и платформы для поздравлений, доводя каждый до реального пользователя, а не до макета
